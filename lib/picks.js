...
/**
 * @template {Type} T
 * @typedef { [T] extends [ArrayType<infer V>] ? ArrayPick<V> : [T] extends [ObjectType<infer S>] ? ObjectPick<S> : [T] extends [ObjectMapType<infer V>] ? RecordPick<StringType,V> : [T] extends [RecordType<infer K,infer V>] ? RecordPick<K,V> : [T] extends [BooleanType] ? BooleanPick : [T] extends [NumberType] ? NumberPick : [T] extends [StringType<infer U>] ? StringPick<U> : [T] extends [OptionType<infer U>] ? OptionPick<U> : ValuePick<T>} PickOfType
 */
/**
...
class ValuePick extends BasePick {
   ...
   */
  eq(value) {
    return new BooleanPick(boolean, $o.eq(this.expression, value));
  }
   ...
   */
  neq(value) {
    return new BooleanPick(boolean, $o.neq(this.expression, value));
  }
   ...
   */
  gte(value) {
    return new BooleanPick(boolean, $o.gte(this.expression, value));
  }
   ...
   */
  gt(value) {
    return new BooleanPick(boolean, $o.gt(this.expression, value));
  }
   ...
   */
  lte(value) {
    return new BooleanPick(boolean, $o.lte(this.expression, value));
  }
   ...
   */
  lt(value) {
    return new BooleanPick(boolean, $o.lt(this.expression, value));
  }
   ...
   */
  in(list) {
    return new BooleanPick(boolean, $o.in(this.expression, list));
  }
   ...
   */
  match(value) {
    return new BooleanPick(boolean, $o.match(this.expression, value));
  }
}

/**
 * @extends {ValuePick<BooleanType>}
 */
class BooleanPick extends ValuePick {}
...
class StringPick extends ValuePick {
   ...
   */
  like(value) {
    return new BooleanPick(boolean, $o.like(this.expression, value));
  }
   ...
   */
  glob(value) {
    return new BooleanPick(boolean, $o.glob(this.expression, value));
  }
...
class ObjectPick extends BasePick {
   ...
   */
  includes(value) {
    return new BooleanPick(boolean, $o.includes(this.expression, value));
  }
}
...
class RecordPick extends BasePick {
  ...
  /**
   * @param {(value: PickOf<V>, key: PickOf<K>) => BooleanPick} func
   */
  some(func) {
    return new BooleanPick(
      boolean,
  ...
  every(func) {
    return new BooleanPick(
      boolean,
      $o.not(
        this.some((...args) => new BooleanPick(boolean, $o.not(func(...args))))
          .expression
      )
    );
  }
...
class RowPick extends BasePick {
  ...
  /**
   * @param {ObjectType<T>} type
   * @param {{expression: Expression} | {tableName: string} | {alias: string} | null} context
   */
  ...
  field(fieldName) {
    ...
    if ('alias' in this.#context) {
      return makePick(
        this.type.properties[fieldName],
        $o.field(fieldName, this.#context.alias, true)
      );
    }
    return makePick(
      this.type.properties[fieldName],
...
function makeTypePick(type, expression) {
  ...
  if (type instanceof BooleanType) {
    return /** @type {any} */ (new BooleanPick(type, expression));
  }
